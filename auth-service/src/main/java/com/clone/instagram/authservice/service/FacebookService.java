...
public class FacebookService {
    ...
    public String loginUser(String fbAccessToken) {
        ...
        return userService.findById(facebookUser.getId()).map(Optional::of)
                .orElseGet(() -> Optional.ofNullable(userService.registerUser(convertTo(facebookUser), Role.FACEBOOK_USER)))
